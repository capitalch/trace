function Comp2() {
    ...
    function createInvoiceData(traceCompany: any, traceInvoice: any) {
        const tc = traceCompany, ti = traceInvoice.jsonResult
        const i: { invoiceInfo: any, companyInfo: any, billTo: any, shipTo: any, items: any[], summary: any, transactions: any } = {
            invoiceInfo: null,
            companyInfo: null,
            billTo: null,
            shipTo: null,
        ...
        i.items = ti.salePurchaseDetails.map((x: any) => (
            {
                desc: ''.concat(x.catName, ', ', x.brandName, ', ', x.label, ', ', 'Serial nos ', x.serialNumbers, ', HSN ', x.hsn),
                qty: x.qty,
                price: x.price,
                pricegst: x.priceGst,
                gstRate: x.gstRate,
