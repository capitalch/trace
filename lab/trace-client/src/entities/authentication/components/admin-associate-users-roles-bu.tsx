...
import { useAdminAssociateUsersRolesBu } from './admin-associate-users-roles-bu-hook'
...
function AdminAssociateUsersRolesBu() {
    ...
    const { columns,
        ...
        queryId,
        specialColumns,
        summaryColNames, } = useAdminAssociateUsersRolesBu()
    return (
        <Box sx={{ height: 'calc(100vh - 180px)' }}>
            ...
            <XXGrid
                ...
                autoFetchData={true}
                columns={columns}
                jsonFieldPath='jsonResult.clientEntityRoleBuUserXs'
