...
import {
Box, useTheme, Theme, // makeStyles,
TextField, Checkbox, Card
                ...
                <Card className="x-gst-container">
                    ...
                    <Box
                        ...
                        <TextField
                            ...
                            name="gstin"
                            // if blank '' initial value is not assigned then uncontrolled component error occurs
                            value={parent?.gst?.gstin || ''}
                            onChange={async (e: any) => {
