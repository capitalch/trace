import { Badge, Box, Button, Card, CloseSharp, errorMessages, IconButton, IMegaData, manageEntitiesState, NumberFormat, TextField, Typography, useContext, MegaDataContext, useEffect, useState, useTheme, utilMethods, useIbuki, } from '../redirect'
...
function LineItem({ item, index, }: any) {
    ...
    function checkAllErrors() {
        ...
        allErrors.productCodeError = items.some((it: any) => it.isProductCodeError) ? errorMessages.productCodeError : ''        

        item.isProductDetailsError = item.productDetails ? false : true
        allErrors.productDetailsError = items.some((it: any) => it.isProductDetailsError) ? errorMessages.productDetailsError : ''        
        ...
        allErrors.gstRateError = items.some((it: any) => it.isGstRateError) ? errorMessages.gstRateError : ''
        allErrors.hsnError = items.some((it: any) => it.isHsnError) ? errorMessages.hsnError : ''
    }
}
