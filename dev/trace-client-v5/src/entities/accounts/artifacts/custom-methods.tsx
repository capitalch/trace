...
// const { emit, hotFilterOn } = usingIbuki()
const customMethods: any = {
    ...
    //         const dateFormat = getFromBag('dateFormat') // 'DD/MM/YYYY'
    ...
    //         header['tranDate'] = moment(header['tranDate'], dateFormat).format(
    //             isoFormat
    //         )
    ...
    //                     (el: any) =>
    //                         args.includes(el.accClass) && el.accLeaf === 'Y'
    //                 )
    //             )
    //         )
    //         .subscribe((d: any) => {
