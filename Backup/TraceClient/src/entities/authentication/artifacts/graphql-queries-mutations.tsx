...
// , clientEntityXView: gql`
    // query clientEntityXView {
    //     authentication {
    //     clientEntityXView
    // }}`

    // , clientsWithUsersView: gql`
    //     query clientsWithUsersView {
    //         authentication {
    //             clientsWithUsersView
    // }}`
    ...
    // , doesExistUserEmail: (value: any) => gql`
    // query doesExistUserEmail {
    //     authentication {
    //         doesExistUserEmail(value:"${value}")
    // }}`
