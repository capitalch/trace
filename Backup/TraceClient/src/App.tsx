...
const App: React.FC = () => {
  const theme = createMuiTheme({
    palette: {
      ...
      blueGrey: { main: blueGrey[500], dark: blueGrey[900], light: blueGrey[100] },
      ...
      deepPurple: { main: deepPurple[900], dark: deepPurple[900], light: deepPurple[400] },
      ...
      lightBlue: { main: lightBlue[600], dark: lightBlue[900], light: lightBlue[500] },
