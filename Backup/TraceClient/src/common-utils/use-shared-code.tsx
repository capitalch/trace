...
function useSharedCode(meta: any) {
    ...
    const { getValidationFabric, resetForm, getFormData,
        resetFormErrors, clearServerError, doFormRefresh, showServerError
    ...
    function closeDialog(): void {
        ...
        meta.current.isMounted && resetFormErrors(meta.current.dialogConfig.formId)
    ...
    async function submitDialog(options: DialogOptions) {
        ...
        try {
            ...
            if (isValidForm(formId)) {
                ...
                setRefresh({})
                // const data2 = getFormData(formId)
