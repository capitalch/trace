...
function validateJsonStructure(id: string, formJson: any, componentStore: any, entityName: string) {
    // const { artifacts }: any = registerArtifacts()
    // const [getArtifacts]:any = useReactForm
